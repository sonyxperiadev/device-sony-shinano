...
This is the Android device configuration for Xperia Z2.
...
Put the following snippet in `.repo/local_manifests/sirius.xml`:
...
You should now have directories named `vendor/sony/shinano` and `vendor/sony/sirius` in your tree.

* `repo sync`
* `source ./build/envsetup.sh`
* `lunch aosp_d6503-userdebug`
* `make`
...
* `fastboot flash userdata out/target/product/sirius/userdata.img`
* `fastboot flashall`
